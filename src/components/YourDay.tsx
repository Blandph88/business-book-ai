...
import { useAiAvailable, useAiBackend, aiPromptStream } from "../ai/ai";
...
// The footer's privacy claim must match the tier that ACTUALLY generated the brief (F2): the old
// hardcoded "on your machine" overclaimed on BYOK/demo, where the data genuinely leaves — a direct
// violation of the never-claim-more-than-is-true privacy promise.
function privacySuffix(backend?: string, byok?: boolean): string {
  switch (backend) {
    case "webllm": return "generated in your browser.";
    case "builtin":
    case "ollama": return "generated on your machine.";
    case "byok": return "generated with your own key (sent to your AI provider).";
    case "democloud": return "generated by Freehold's hosted demo AI.";
    default: return byok ? "generated with your own key (sent to your AI provider)." : "generated by your configured AI.";
  }
}

export function YourDay({ today, contacts, agenda, hotOpps, stale, aging, onDraft }: YourDayProps) {
  const aiReady = useAiAvailable();
  const aiBackend = useAiBackend();
  ...
  return (
    <section className="yourday">
      ...
      <p className="yourday-note">
        {aiReady
          ? `Brief from your own data — ${privacySuffix(aiBackend.backend, aiBackend.byok)}`
