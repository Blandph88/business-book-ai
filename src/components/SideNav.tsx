...
// rail with just an expand button at the top; expanded it's an accordion drawer listing the
// nav items (same order as the wide top-bar nav) plus an Import action. Picking an item — or
// the backdrop — collapses it again.
export function SideNav({
  ...
  return (
    <>
      {open && <div className="sidenav-backdrop" onClick={onToggle} />}
